...
contract DynamicHandler is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function getDynamicInfo(uint256 tokenId) external view returns(DynamicInfo memory) {
